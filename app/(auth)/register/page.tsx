      ...
      <div className="mx-auto grid min-h-screen grid-cols-1 lg:grid-cols-[1.15fr_0.85fr]">
        <section className="relative hidden h-full overflow-hidden lg:block">
          ...
          <div className="absolute left-8 bottom-12 z-10 max-w-md text-white">
            <h1 className="text-4xl font-semibold leading-tight">Start your culinary journey.</h1>
            <p className="mt-4 text-base text-white/80">
              Create an account to unlock personalised recipes, meal plans, and smart shopping lists.
            </p>
          </div>
        </section>
            ...
            <div className="mx-auto w-full p-8">
              <div className="text-slate-900">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-600">Join the community and start cooking smarter.</p>
                </div>
              </div>
              ...
              >
                <div>
                  ...
                  <div className="relative mt-2">
                    ...
                    <Input id="name" name="name" type="text" placeholder="Marie Dupont" className="h-12 pl-10 border-slate-200 bg-white text-slate-900 placeholder:text-slate-400" />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative mt-2">
                    ...
                    <Input id="email" name="email" type="email" placeholder="marie@recipehub.com" className="h-12 pl-10 border-slate-200 bg-white text-slate-900 placeholder:text-slate-400" />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative mt-2">
                    ...
                    <Input id="password" name="password" type={showPassword ? "text" : "password"} placeholder="at least 8 characters" className="h-12 pl-10 border-slate-200 bg-white text-slate-900 placeholder:text-slate-400" />
                ...
                <Button type="submit" className="w-full rounded-lg bg-orange-500 px-4 py-5 text-base font-semibold text-white hover:bg-orange-600">Create Account</Button>
              </form>
              ...
              <div className="pt-4 text-center text-sm text-slate-600">
                <p>
                  ...
                  <Link href="/login" className="font-semibold text-slate-900 hover:text-orange-600">Sign In</Link>
                </p>
              </div>
            </div>
          </div>
